...
describe("Fee distribution", () => {
    ...
    describe("#sendFees", () => {
        it("sends fees in ETH without royalties", async () => {
            ...
            await this.FeeSplitter.sendFees(ethers.constants.AddressZero, {
    ...
    describe("ETH fees", () => {
        beforeEach(async () => {
            ...
            await this.FeeSplitter.sendFees(this.wallet3.address, {
        ...
        it("retrieves split ETH fees", async () => {
            ...
            const tx = await this.FeeSplitter.release(this.alice.address)
        ...
        it("claims fees as NFT owner", async () => {
            ...
            const tx = await this.FeeSplitter.connect(this.wallet3).release(this.wallet3.address)
            const spentOnTx = await getETHSpentOnGas(tx)
    ...
    describe("ERC20 tokens fees", () => {
        beforeEach(async () => {
            ...
            await this.ERC20Mocks[0].approve(this.FeeSplitter.address, amount1)
